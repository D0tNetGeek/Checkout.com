...
namespace Checkout.Web.Controllers.Api.v1
{
    ...
    public class CartController : BaseApiController
    {
        ...
        [HttpPut]
        public async Task<CartProduct> Save(CartItem item) => await cartService.SaveAsync(item);
        ...
        private void ValidateCartId(Guid cartId)
        {
            if (cartId.Equals(Guid.Empty))
                throw new CartException("Cart Id was not supplied!!");
        }
    }
}